...
public class ButtonCopyFiles extends ButtonBase {
    ...
    public ButtonCopyFiles(Context context) {
        super(context);
        init();
    }

    public ButtonCopyFiles(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ButtonCopyFiles(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setActionFinishedListener(Consumer<ButtonCopyFiles> l) {
        this.actionFinishedListener = l;
    }

    public void setActionProgressListener(Consumer<ButtonCopyFiles> l) {
    ...
    private void onClick() {
        ...
        Runnable buildRequestAndShowConfirm = () -> {
            request = new ModelFilesActionRequest(
                    ModelFilesActionRequest.FilesAction.Copy,
